            ...
            portableWrapper::applyKernel(LAMBDA(LARE::T_indexType ix, LARE::T_indexType iy, LARE::T_indexType iz) {
                ...
                for (LARE::T_indexType lower_level = 1; lower_level < nUpperLevel; ++lower_level) {
                    ...
                    for (LARE::T_indexType upper_level = lower_level + 1; upper_level < nUpperLevel; ++upper_level) {
                        ...
                        LARE::T_dataType rad_de_exc = get_radiative_de_excitation(plasma_source, lower_level, upper_level);
                    ...
                    LARE::T_dataType coll_ion = interpolate_collisional_ionisation(plasma_source, temperature_electron, lower_level);
