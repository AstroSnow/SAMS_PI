...
namespace examples{
        ...
        void Hillier<T_EOS>::attachBoundaryConditions(const std::string& varName, SAMS::harness &harness)
        {
         ...
         */
        template<typename T_EOS>
        void Hillier<T_EOS>::controlVariables(LARE::LARE3D<T_EOS>::simulationData &data)
        {
         ...
         */
        template<typename T_EOS>
        void Hillier<T_EOS>::setDomain(SAMS::harness &harness, LARE::LARE3D<T_EOS>::simulationData &data) 
        {
         ...
         */
        template<typename T_EOS>
        void Hillier<T_EOS>::setBoundaryConditions(SAMS::harness &harness)
        {
         ...
         */
        template<typename T_EOS>
        void Hillier<T_EOS>::initialConditions(SAMS::harness &harnessRef, LARE::LARE3D<T_EOS>::simulationData &data)
        {
       ...
       /**
         ...
         */
        template<typename T_EOS>
        void Hillier<T_EOS>::queryTerminate(bool &terminate, LARE::LARE3D<T_EOS>::simulationData &data, SAMS::timeState &tData){
         ...
         */
        template<typename T_EOS>
        void Hillier<T_EOS>::queryOutput(bool &shouldOutput, LARE::LARE3D<T_EOS>::simulationData &data, SAMS::timeState &tData){
